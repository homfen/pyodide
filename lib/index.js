...
const languagePluginLoader = (
  self = window,
  languagePluginUrl = "https://pyodide-cdn2.iodide.io/v0.15.0/full/"
) =>
  new Promise((resolve, reject) => {
    ...
    Module.runPython = (code) =>
      Module.pyodide_py.eval_code(code, Module.globals);
   ...
   */
    ...
    Module.function_supports_kwargs = function (funcstr) {
      ...
      throw new Error(
        "Assertion failure: this is a logic error in \
